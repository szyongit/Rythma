...
selectMenu.addOptions({ label: 'POP', value: 'newpop' }, { label: 'ROCK', value: 'rock' }, { label: 'HIPHOP', value: 'hiphop' }, { label: 'US RAP ONLY', value: 'usrap' }, { label: 'HARDSTYLE', value: 'hardstlye' }, { label: 'CHILLHOP', value: 'chillhop' }, { label: 'DANCE', value: 'dance' }, { label: 'CREATEST HITS', value: 'greatesthits' }, { label: '2010+ THROWBACKS', value: '2010s' }, { label: '2000+ THROWBACKS', value: '2000s' }, { label: '1990+ THROWBACKS', value: '90s' }, { label: 'I❤BASS BY HBZ', value: 'ilovebass' }, { label: 'NIGHT CLUB', value: 'club' }, { label: 'BEACH VIBEZ', value: 'beach' }, { label: 'Christmas', value: 'christmas' }, { label: 'TRASHPOP', value: 'trashpop' }, { label: 'TOP 100 CHARTS GERMANY', value: 'chartsgermany' }, { label: 'GERMAN SCHLAGER ON MALLORCA', value: 'germanschlager' }, { label: 'GERMAN RAP', value: 'germanrap' });
